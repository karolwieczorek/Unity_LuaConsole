...
namespace UnityPythonConsole.Assets.Code {
    public class LuaConsole : MonoBehaviour {
        ...
        private void Start() {
            ...
            luaLogsToggle.onValueChanged.AddListener((x) => { ReloadConsole(); });
        ...
        public void AddLuaLog(string text) {
            if (string.IsNullOrEmpty(text))
                return;
